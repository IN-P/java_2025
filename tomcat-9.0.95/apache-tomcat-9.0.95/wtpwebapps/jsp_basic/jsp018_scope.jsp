...
<body>
	<div class="container card my-5">
		...
		1. application (웹애플리케이션 실행되고 있는동안) > session(브라우저 종료)
			> request(요청) > page(해당페이지)
		2. 객체.setAttibute("속성","값") / 객체.getAttribute("속성")	
		</pre>
		...
		pageContext.setAttribute("name","A.pageContext - 현재페이지에서만 유지");
		%>
