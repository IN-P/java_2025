...
<body>
	<div class="container card my-5">
		<h3 class="card-header">session - 서버측에 저장되는 정보</h3>
		
		<table class="table table-borered table-hover my-3">
			<caption>SESSION</caption>
			<tbody>
			<%
				String username = (String)session.getAttribute("username"); //Object 형변환해줘야함			
