...
public class BankProject_v2_0_0 {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			switch(input) {
			case 1: signUp(id,pwd,age,cash,scan); break; //회원가입 
			case 2: case 3: case 4: case 5:
				int index=infoChk(id,pwd,scan);//회원정보확인후 해당 인덱스 반환
				if(index==-77) {System.out.println("정보를 다시 확인해주세요."); break;}//특정기능:기능초기화
				switch(input) {//확인완료되면 각기능 시작
				case 2: showUser(id,pwd,age,cash,index); break;
				case 3: deposit(cash,index,scan); break;
				case 4: withdraw(cash,index,scan); break;
				case 5: delete(id,pwd,age,cash,index,scan); break; 
	...
	//회원가입 메소드
	public static void signUp(String[] id,String[] pwd,int[] age,long[] cash,Scanner scan) { 
	...
	public static int infoChk(String[] id,String[] pwd,Scanner scan) {
	...
	//회원정보 메소드
	public static void showUser(String[] id,String[] pwd,int[] age,long[] cash,int index) {
		System.out.printf("==계좌조회\nID : %s\nPASS : %s\n나이 : %d\n잔액 : %d\n",id[index],pwd[index],age[index],cash[index]);
	}
	//입금 메소드
	public static void deposit(long[] cash,int index,Scanner scan) {
		System.out.print("입금 : ");cash[index]+=scan.nextInt();
		System.out.println("==입금완료\n잔액 : "+cash[index]);
	}
	//출금 메소드
	public static void withdraw(long[] cash,int index,Scanner scan) {
	...
	//회원탈퇴 메소드
	public static void delete(String[] id,String[] pwd,int[] age,long[] cash,int index,Scanner scan) {
